...
SWEP.LimitedStock           = false -- buyable multiple times
...
function SWEP:PrimaryAttack()
   ...
   if IsValid(hitEnt) then
      ...
      if hitEnt:IsPlayer() or hitEnt:GetClass() == "prop_ragdoll" then
		 ...
		 self.Owner:ConCommand("playgamesound Weapon_Knife.Hit")
      else
		self.Owner:ConCommand("playgamesound Weapon_Knife.HitWall")
	  end
   else
      if tr.HitWorld then
	     self.Owner:ConCommand("playgamesound Weapon_Knife.HitWall")
	  else
	     self.Owner:ConCommand("playgamesound Weapon_Crowbar.Single")
	  end
   end
   ...
   if SERVER and tr.Hit and tr.HitNonWorld and IsValid(hitEnt) then
      if hitEnt:IsPlayer() then
	     self.Owner:ConCommand("playgamesound Weapon_Knife.Hit; playgamesound Flesh.Break; playgamesound Flesh_Bloody.ImpactHard")
