...
if SERVER then
	resource.AddFile("materials/vgui/ttt/icon_deathstation.vtf")
	resource.AddFile("sound/deathstation/deathstation_trigger.mp3")
else
...
function SWEP:HealthDrop()
   if SERVER then
      ...
      local health = ents.Create("ttt_deathstation")
